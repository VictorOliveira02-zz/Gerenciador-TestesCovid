...
void Cadastrar_testes(Cadastro **testes, int *posicao)
{
	...
	//tamanho inicializa da posicao 0 caso não tenha nehum cadastro anteriormente,caso tenha,inicializa da posição seguinte.
...
void cancela_teste(Cadastro cadastros[], int num_teste)
{
	...
	//Caso a escolha seja sim,a funçao strcpy copia 'N' para "Valido".
  	if (opcao == 'S')
  	{
